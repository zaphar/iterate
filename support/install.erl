...
main(["create", Arg1]) ->
  do_create(Arg1);
main(["install", Arg1]) ->
  install_with_args(Arg1);
main(["install", Arg1, Arg2]) ->
  install_with_args(Arg1, Arg2);
main([Arg1, Arg2]) ->
  install_with_args(Arg1, Arg2).

install_with_args() ->
  install_with_args("iterate").

install_with_args("rel="++Rel) ->
  install_with_args(Rel);
install_with_args("root="++Root) ->
  install_with_args("iterate", Root);
install_with_args(Rel) ->
  install_with_args(Rel, "/usr/local/iterate").

install_with_args("rel="++Rel, "root="++Root) ->
  install_with_args(Rel, Root);
install_with_args("root="++Root, "rel="++Rel) ->
  install_with_args(Rel, Root);
install_with_args(Rel, Root) ->
